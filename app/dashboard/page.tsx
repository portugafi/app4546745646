...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-red-900 to-yellow-800 relative overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-between p-6">
        <div className="flex items-center">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white">PortugaFi Dashboard</h1>
            {user && (
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center p-6 pb-32">
        <div className="text-center">
          ...
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-4">Welcome to PortugaFi</h2>
          <p className="text-xl text-yellow-200 max-w-2xl mx-auto mb-8">
            Connected to the future of Portuguese finance
          </p>
        </div>
      </div>
